---
title: "Figures for Mass Cytometry Poster"
...
plt <- ggplot(subset(mass_cyto_tall, MeasurementType  == "Median" & ContrastAgent != "control"), aes(x=Concentration, y=value, group=ContrastAgent, col=ContrastAgent, shape=ContrastAgent)) +
