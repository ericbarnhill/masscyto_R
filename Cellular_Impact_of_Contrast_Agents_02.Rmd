...
[SV:] Log-transformation often makes sense for variables that can only have  positive values. So using a log-transform for both value and concentration is reasonable here.
